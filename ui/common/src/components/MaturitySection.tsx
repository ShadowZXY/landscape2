  ...
  return (
    ...
    >
      <div class={`position-relative border ${Wrapper} ${props.class}`}>
        <div class={`position-absolute px-2 bg-white fw-semibold ${FieldsetTitle}`}>成熟度</div>
        ...
        <div class="position-relative mt-2">
          <div class="d-flex flex-row justify-content-between">
            <div class="d-flex flex-column align-items-center">
              ...
              <small class={`text-uppercase fw-semibold text-muted mt-2 ${StatusLegend}`}>Experimental</small>
            </div>
            ...
            <div class="d-flex flex-column align-items-center">
              <div
                ...
                classList={{
                  [ActiveMaturityBadge]: ['incubating', 'stable', 'archived'].includes(props.item.maturity!),
                }}
              >
            ...
            <div class="d-flex flex-column align-items-center">
              <div
                class={`badge rounded-0 p-2 ${MaturityBadge}`}
                classList={{
                  [ActiveMaturityBadge]: ['stable', 'archived'].includes(props.item.maturity!),
                }}
              >
                {props.item.graduated_at || '-'}
              </div>
              <small class={`text-uppercase fw-semibold text-muted mt-2 ${StatusLegend}`}>stable</small>
            </div>
          </div>
